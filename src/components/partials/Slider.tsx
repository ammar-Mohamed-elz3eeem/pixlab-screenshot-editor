  ...
  return (
    <div className="flex flex-row justify-between items-center gap-4 px-4">
      ...
      <div className="w-full max-w-[50%]">
        <div className="w-full flex items-center justify-center relative py-3" dir="ltr" data-orientation="horizontal" aria-disabled="false">
          <span ref={sliderBoxRef} data-orientation="horizontal" className="h-[12px] w-full dark:bg-gray-100 bg-gray-900 rounded-sm relative border dark:border-gray-300 border-gray-600 shadow-[0_0_2px_rgba(0,0,0,0.1)] flex items-center">
            <span ref={sliderColorRef} data-orientation="horizontal" className="bg-gradient-to-br dark:bg-white bg-gray-700/80 absolute h-full rounded-sm" style={{ left: "0%", right: "37.5%" }}></span>
          </span>
          <span ref={sliderBtnRef} onMouseDown={onMouseDown} style={{ position: 'absolute', left: "calc(62.5% - 2px)" }}>
            <span role="slider" aria-valuemin={30} aria-valuemax={150} className="bg-gradient-to-br from-[#737373] to-[#262626] dark:from-[#e5e5e5] dark:to-[#a3a3a3] cursor-pointer duration-100 focus:border-black hover:border-black focus:scale-[1.05] dark:border-gray-500 dark:hover:border-gray-200 dark:focus:border-gray-200 hover:scale-[1.05] h-[20px] w-[16px] border-[1px] border-gray-500 rounded-[5px] flex focus:outline-none ease-linear shadow-[0_0_12px_rgba(0,0,0,0.15)] relative group" aria-valuenow={105}>
