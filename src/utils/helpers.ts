...
export const RounedImage: any = fabric.util.createClass(fabric.Image, {
  ...
  initialize: function (
    element: string | HTMLImageElement | HTMLCanvasElement,
    options: Record<string, number> & fabric.IImageOptions,
  ) {
...
RounedImage.fromURL = function (
  url: string,
  callback: (img: typeof RounedImage) => typeof RounedImage,
  imgOptions: Record<string, number> & fabric.IImageOptions,
) {
